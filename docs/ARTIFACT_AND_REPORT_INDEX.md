...
| `artifacts/testing/positive_removal_results.json` | DERIVED | `artifacts/metrics/nested_positive_removal.json`, `artifacts/metrics/stability_stress_v2.json` |  |
| `artifacts/testing/adversarial_validation.json` | DERIVED | `artifacts/metrics/nested_shift_shield.json` |  |
...
| `artifacts/testing/offline_results.json` | PRESENT | - | written by scripts/test_offline.sh |
...
| `artifacts/metrics/feature_subset_ablation.csv` | DERIVED | `artifacts/metrics/nested_feature_family_arms.json`, `artifacts/metrics/family_dropout_v2.json` |  |
...
| `artifacts/features/final_selected_features.json` | DERIVED | `artifacts/features/selected_features_v2.json` | post-firewall stability selection behind the champion's 120 features |
| `artifacts/features/final_selection_frequency.csv` | DERIVED | `artifacts/features/selection_frequency_v2.csv` | post-firewall per-fold selection frequencies |
...
|---|---|---|
| `docs/FINAL_XHIGH_VALIDATION_REPORT.md` | itself | generated by muleguard.cli.final_report, last in the validation run, so it quotes the verdict that run produced |
...
| `docs/NESTED_CV_MODEL_TOURNAMENT.md` | itself | generated by muleguard.cli.nested_report from nested_cv.json, the promotion arbiter and the paired tuning test |

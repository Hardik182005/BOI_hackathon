# Validation Lab Test Report

_Required by section 58 of the final-validation prompt._

**The report lives at [`docs/VALIDATION_LAB_REPORT.md`](VALIDATION_LAB_REPORT.md).** That file is the
...
It covers the judge-facing validation lab.

...
**The report lives at [`docs/FALSE_POSITIVE_CONTROL_REPORT.md`](FALSE_POSITIVE_CONTROL_REPORT.md).** That file is the
...
It covers false-positive control, including the merchant verifier.

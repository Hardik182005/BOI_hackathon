# Ui Metric Consistency

_Required by section 58 of the final-validation prompt._

**The report lives at [`docs/FINAL_FRONTEND_UI_REPORT.md`](FINAL_FRONTEND_UI_REPORT.md).** That file is the
...
It covers every number shown in the UI traced to the artifact it came from.
